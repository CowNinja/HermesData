...
§
Comfy :8188/:8189. Python D:/ paths (not /d/). RP: orchestrator not FAL. Gallery dedup: scripts/comfy_purge_duplicate_images.py + skill comfyui-gallery-ops; --reconcile-only; quarantine first. Canon Operations/ComfyUI-Gallery-Immersion-Dedup-CANONICAL-2026-07-19.
§
...
§
Remote: RustDesk+Tailscale; RDP phone 100.103.254.47. Travel: no gateway restart w/o green light. Jeff: ultra-brief TLDR; vault=depth. Overnight game cooks when Jeff says keep going — no continue-popups.
§
Silo kitchen (silo thread): six_numbers only for metrics; max 4 tool turns; Barney tables; never kill gateway.
§
Alice/RP: registry-locked; harem via orchestrator+Image-Rider. Mom: talk_to_jan.py. Post-crash: ACK-ONLINE+1 line.
§
