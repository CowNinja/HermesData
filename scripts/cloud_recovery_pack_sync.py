...
PACK_FILES: list[tuple[Path, str]] = [
    ...
    (HERMES / "scripts" / "backup_k_mirror_once.py", "scripts-critical/backup_k_mirror_once.py"),
    (HERMES / "scripts" / "backup_health_alarm.py", "scripts-critical/backup_health_alarm.py"),
    (HERMES / "scripts" / "backup_layers_status.py", "scripts-critical/backup_layers_status.py"),
    (HERMES / "scripts" / "backup_critical_state_zip.py", "scripts-critical/backup_critical_state_zip.py"),
    (HERMES / "scripts" / "backup_k_silo_life_mirror_once.py", "scripts-critical/backup_k_silo_life_mirror_once.py"),
    (HERMES / "scripts" / "k_resilience_layout_once.py", "scripts-critical/k_resilience_layout_once.py"),
    (HERMES / "scripts" / "vault_github_clean_mirror_push.py", "scripts-critical/vault_github_clean_mirror_push.py"),
    (HERMES / "scripts" / "vault_history_sqlite_purge_prepare.py", "scripts-critical/vault_history_sqlite_purge_prepare.py"),
    ...
    (VAULT / "Operations" / "Backup-Architecture-Audit-2026-08-01.md", "Operations/Backup-Architecture-Audit-2026-08-01.md"),
    (VAULT / "Operations" / "Backup-Architecture-Cook-2026-08-01.md", "Operations/Backup-Architecture-Cook-2026-08-01.md"),
    (VAULT / "Operations" / "Backup-Five-Primaries-Cadence-2026-08-02.md", "Operations/Backup-Five-Primaries-Cadence-2026-08-02.md"),
    (VAULT / "Operations" / "Vault-GitHub-History-Purge-Runbook-2026-08-01.md", "Operations/Vault-GitHub-History-Purge-Runbook-2026-08-01.md"),
    ...
    (K_RES / "K-RESILIENCE-MAP.md", "K-RESILIENCE-MAP.md"),
    (K_RES / "restore" / "RESTORE-FROM-K.md", "restore/RESTORE-FROM-K.md"),
