...
PLAYBOOK: dict[str, dict] = {
    ...
    "gateway_dual": {
        "patterns": [r"dual.?gateway", r"two.?gateway", r"multi.?listener", r"double.?boot"],
        "title": "Dual gateway / multi-listener",
        "plays": [
            {
                "id": "A",
                "label": "Measure listeners",
                "risk": "low",
                "cmd": r"python D:\HermesData\scripts\single_gateway_instance_check.py",
                "why": "Soft-fail receipt; count LISTENING on :8642",
            },
            {
                "id": "B",
                "label": "Silent green",
                ...
                "why": "YELLOW if multi + health up",
            },
            {
                "id": "C",
                "label": "Jeff/Admin: disable dual schtask Hermes_Gateway",
                "risk": "medium",
                "cmd": r'schtasks /Query /TN "\Hermes_Gateway" /V',
                "why": "Landmine direct gateway.run; retarget to service VBS when Admin",
            },
        ],
        "do_not": ["blind taskkill all pythonw", "start third supervisor"],
        "recommend": "A",
    },
    "silo_freeze": {
        "patterns": [
